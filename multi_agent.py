...
#2nd Agent: Our Healthy Breakfast Planner
...
#3rd Agent for checking the breakfast's price
...
#Let us expose our 1st and 2nd agent as tool
...
#4th agent will be the glue. Will use two of our agents 
#as tools and handoff the output to 3rd agent - price checker agent
...
async def main():
    ...
    user_query = "I'm a busy person and I want to eat healthy breakfasts. I like to eat oatmeal and eggs. What is a healthy breakfast for me? Give me two options."
